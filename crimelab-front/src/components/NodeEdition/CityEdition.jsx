...
import '../../css/NodeEdition/editCity.css';
...
function CityEdition() {
    ...
    const fetchData = async () => {
        try {
            ...
            setCityData(data); // Initialise les données de la ville
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_API_URL}/cities/${cityData._id}`, {
                ...
                body: JSON.stringify(cityData) // Envoie toutes les données de la ville
            });
            ...
            window.location.href = '/details'; // Redirige après la mise à jour
