...
const testimoniesId = db.testimonies.insertMany([
    {
        ...
        "description": "J'ai remarqué deux hommes rôder autour d'une voiture. L'un d'eux, grand avec une veste à capuche noire, semblait forcer la portière pendant que l'autre faisait le guet et qu'un troisieme attendait dans une autre voiture. Ils sont montés rapidement et sont partis avant que la police arrive. Celui qui avait gardé la voiture a lui été interpellé.",
        "date": new Date("2021-01-02")
    },
    {
        "person": personsId.insertedIds[4],
        "description": "Je mettais mes affaires dans mon coffre quand j'ai entendu un bruit métallique. J'ai vu deux types entrer précipitamment dans une Renault Mégane grise. Ils se sont séparés en deux groupes quand la police est arrivée",
        "date": new Date("2021-01-02")
    },
    {
        "person": personsId.insertedIds[5],
        "description": "Je suis allé au cinéma, quand je suis revenu, ma voiture n'était plus là. J'ai vu deux hommes, l'un grand et l'autre petit, s'enfuir à bord de ma Renault Mégane grise.",
...
const casesId = db.cases.insertMany([
    {
        ...
        "date": new Date("2021-01-01T20:00:00Z"),
        "location": locationsId.insertedIds[0],
        "suspects": [personsId.insertedIds[0], personsId.insertedIds[1], personsId.insertedIds[2]],
        "witnesses": [personsId.insertedIds[3], personsId.insertedIds[4]],
        "victims": [personsId.insertedIds[5]],
        "testimonies": [testimoniesId.insertedIds[0], testimoniesId.insertedIds[1], testimoniesId.insertedIds[2]]
    },
    {
        "type": "Cambriolage",
...
const fadettesId = db.fadettes.insertMany([
    {
        "date": new Date("2021-01-01T18:00:00Z"),
        "duration": 20,
    ...
    {
        "date": new Date("2021-01-01T19:55:00Z"),
        "duration": 10,
        "caller": personsId.insertedIds[0],
        "receiver": personsId.insertedIds[1],
        "type": "sms",
    ...
    {
        "date": new Date("2021-01-01T20:05:00Z"),
        "duration": 8,
        "caller": personsId.insertedIds[0],
        "receiver": personsId.insertedIds[1],
        "type": "sms",
    ...
    {
        "date": new Date("2021-01-01T20:30:00Z"),
        "duration": 198,
    ...
    {
        "date": new Date("2021-01-01T21:00:00Z"),
        "duration": 23,
    ...
    {
        "date": new Date("2021-01-01T23:00:00Z"),
        "duration": 7,
        "caller": personsId.insertedIds[2],
        "receiver": personsId.insertedIds[0],
        "type": "sms",
